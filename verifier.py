...
# tracks used codes and UIDs that go with them
codes = {}
...
async def check_code(bot: commands.Bot, server_ID: int, msg: discord.Message):
    ...
    if msg.content == codes[msg.author.id]:
        ...
        await msg.author.send("Success! You've now been granted the **SFSU student** role!")
    else:
        await msg.author.send("Sorry, the code you've sent was not correct...")
